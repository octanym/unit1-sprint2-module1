...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
    counter1 returns a function that can be invoked
  2. Which of the two uses a closure? How can you tell?
    counter2 returns a value
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?
    counter1 would be preferable in the scenario that you need to persist an updated value after the inner function returns
    counter2 would be better if there is no need to persist updated values after a function returns
